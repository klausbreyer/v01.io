...
1. **We don't know what we want—we only know it's not what we have.** Like channel surfing on TV—we know it's not what we're currently watching, but we're not sure what we're looking for. This applies to many aspects of life and decision-making.

2. **Men want the same thing from women as from underwear: a certain amount of support and a certain amount of freedom.** This observation about relationships highlights the balance between connection and independence that many people seek.

3. **The creative process requires constant evaluation: "Is this anything?"** This question—whether an idea, joke, or observation has value—is central to the creative process. Not everything is worth pursuing, but you have to create a lot to find what works.
