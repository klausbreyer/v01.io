...
aliases:
  - /posts/2024-impact-appetite-tierlist/
...
[It is all about strategic resource allocation for fixed timeboxes instead of managing a backlog of tickets]({{< relref "/posts/2023/03/shape-up-art-of-constant-de-risking/" >}}).
...
![](matrix-empty@1x.png)
Traditional effort estimates often derail projects. They start with good intentions but quickly spiral as scope creeps in or unforeseen complexities arise. To counter this, [Shape Up uses appetite instead of estimates]({{< relref "/posts/2024/11/shape-up-remote-empowered-product-teams/" >}}). So, instead of asking,
