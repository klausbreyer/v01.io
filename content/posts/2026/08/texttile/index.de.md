...
Also habe ich nach Mexiko, mit bewährter Galerie, getan, was anscheinend jede:r Programmierer:in einmal tun muss. Ich habe mein eigenes CMS geschrieben. Es heißt [Texttile](https://www.texttile.blog/), es ist Open Source, und es ist in Elixir geschrieben.
...
In den meisten Blog-Engines kann nur ein:e Autor:in einen Eintrag bearbeiten. [Texttile](https://www.texttile.blog/) denkt Content-Management als Multiplayer.
...
- [Texttile](https://www.texttile.blog/) lädt nichts von außen. Kein CDN, kein Tracker, kein Captcha, keine gehosteten Fonts, kein Cookie-Banner. Der Browser deiner Leser:innen spricht mit deinem Server und sonst mit niemandem.
...
- Videos kommen von deinem eigenen Server. Wirf eins rein und [Texttile](https://www.texttile.blog/) konvertiert es, Thumbnail inklusive. Kein YouTube-Embed, kein Player von woanders.
- [Texttile](https://www.texttile.blog/) speichert dein Markdown Byte für Byte. Ein Versions-Diff zeigt echte Änderungen und sonst nichts.
...
- Kommentare, ein Newsletter und Statistiken bleiben auf deinem Server. [Texttile](https://www.texttile.blog/) nutzt keine Cookies und speichert keine IP-Adressen.
