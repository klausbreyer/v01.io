---
title: "BUMM, or the State of AI After GPT 6 Astra"
date: 2026-09-09
categories: ["Open Source"]
image: preview.png
linkedin: |
  What a time to be alive. I present: BUMM.

  Over the weekend I tried GPT 6 Astra. With one vague prompt and many iterations on the interface, I built a small beat studio for my son. Hip-hop or techno. Arrange intro, verse and chorus, record your own voice on top. It is frightening how well this already works.

  But I also noticed: the demos are impressive, and the model can surely do all of that. Until you get something out that works the way you want it in real life, it still takes a lot of iterations. And you need a precise feeling for what works and what does not. No model takes that off your hands yet.

  And still. From a loose thought (my kid needs tools to play with beats the way he can scribble on paper) to custom software for him in two hours.

  That is why I love AI so much. Not the efficiency gains. The many small custom things you would never build otherwise. Things that make your loved ones or your neighbours happy.

  Links to the app, the code and the long version are in the first comment.

  Try it: https://klausbreyer.github.io/bumm/
  Code: https://github.com/klausbreyer/bumm
  The long version: https://www.v01.io/posts/2026/09/bumm/
---
...
![BUMM, a small beat studio for kids: arrange intro, verse and chorus, record your voice on top](preview.png)
