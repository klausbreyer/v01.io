...
date: 2026-07-05
categories: ["Product"]
image: framing-10-pm-double-diamond.png
---
...
![The PM Double Diamond](framing-10-pm-double-diamond.png)
...
Here is the uncomfortable truth: if an engineer's job is just executing tickets, an AI can do that job. Writing code from a specification is exactly what AI coding agents are getting good at. The ticket executor role is being automated away.
