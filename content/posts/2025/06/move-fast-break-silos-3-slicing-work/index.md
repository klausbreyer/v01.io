...
Building software is [fundamentally different from manufacturing]({{< relref "/posts/2025/04/move-fast-break-silos-1-software-assembly-line-design-process/" >}}). Software development is an exploratory and creative process where decisions are made continuously within evolving systems. Rigid assembly-line thinking focusing on ticket-driven workflows is not suited and only [creates silos]({{< relref "/posts/2025/04/move-fast-break-silos-2-tickets-create-silos/" >}}).
